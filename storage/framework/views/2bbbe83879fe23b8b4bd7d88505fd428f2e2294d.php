...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1> <?php echo e(trans('labels.Sattlements History')); ?>

            <?php echo e($result['earningsbymonth']['vendors']); ?><small> <?php echo e(trans('labels.Sattlements History')); ?>

                <?php echo e($result['earningsbymonth']['vendors']); ?>...</small> </h1>
        <ol class="breadcrumb">
            ...
            <li class="active"> <?php echo e(trans('labels.Sattlements History')); ?>

                <?php echo e($result['earningsbymonth']['vendors']); ?></li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"> <?php echo e(trans('labels.Sattlements History')); ?>

                            <?php echo e($result['earningsbymonth']['vendors']); ?></h3>
                    </div>
                            ...
                            <div class="col-xs-12">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                        <td><button type="button" class="btn btn-gray accordion-toggle" data-toggle="collapse" data-target="#<?php echo e($key); ?>_collapse" aria-expanded="true"><span class="fa fa-angle-down fa-lg"></span></button></td>
                                            <td><?php echo e($monthlyearning['orders_id']); ?></td>
                                            <td><?php echo e($monthlyearning['month']); ?></td>
                                            <td><?php echo e($result['setting'][19]->value); ?><?php echo e($monthlyearning['item_price']); ?>

                                            </td>
                                            <td><?php echo e($result['setting'][19]->value); ?><?php echo e($monthlyearning['shipping_cost']); ?>

                                            </td>
                                            <td><?php echo e($result['setting'][19]->value); ?><?php echo e($monthlyearning['coupon_amount']); ?>

                                            </td>
                                            <td><?php echo e($result['setting'][19]->value); ?><?php echo e($monthlyearning['total_amount']); ?>

                                            </td>
                                            <td><?php echo e($result['setting'][19]->value); ?><?php echo e($monthlyearning['admin_commision']); ?>

                                            </td>
                                            <td><?php echo e($result['setting'][19]->value); ?><?php echo e($monthlyearning['vendor_balance']); ?>
                                        ...
                                        <tr>
                                            <td colspan="10" class="hiddenRow">
                                                <div class="accordian-body collapse" id="<?php echo e($key); ?>_collapse" data-order-id="47" aria-expanded="true" style="">
                                                            ...
                                                            <tr>
                                                                <td colspan="" style="width: 20%">
                                                                    <p><strong>Vendor's Name </strong><br>
                                                                        <?php echo e($monthlyearning['vendors_data']->first_name); ?>

                                                                        <?php echo e($monthlyearning['vendors_data']->last_name); ?>

                                                                    </p>
                                                                    <p><strong>Vendor's Contact Number </strong><br>
                                                                    <?php echo e($monthlyearning['vendors_data']->phone); ?>
                                                                ...
                                                                <td colspan="" style="width: 20%">
                                                                    <p><strong>Customer's Name </strong><br>
                                                                        <?php echo e($monthlyearning['orders_data']->customers_name); ?>

                                                                    </p>
                                                                    <p><strong>Customer's Contact No.</strong><br><?php echo e($monthlyearning['orders_data']->delivery_phone); ?>
                                                                ...
                                                                <td colspan="1" style="width: 20%">
                                                                    <p><strong>Driver's Name</strong><br>
                                                                        <?php echo e($monthlyearning['deliveryboy_data']->first_name); ?>

                                                                        <?php echo e($monthlyearning['deliveryboy_data']->last_name); ?>
                                                                ...
                                                                <td colspan="1" style="width: 20%">                                                                    
                                                                    <p>
                                                                        ...
                                                                        <?php echo e($monthlyearning['orders_data']->delivery_time); ?>
                                                                ...
                                                                <td colspan="1" style="width: 20%">                                                                    
                                                                    <p>
                                                                        ...
                                                                        <?php echo e($result['setting'][19]->value); ?><?php echo e($monthlyearning['orders_data']->shipping_cost); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/rumahsayurkita/resources/views/admin/deliveryboys/finance/orders.blade.php ENDPATH**/ ?>