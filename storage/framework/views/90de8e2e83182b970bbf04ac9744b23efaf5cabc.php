<?php $__env->startSection('content'); ?>
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1> <?php echo e(trans('labels.EditNewsCategories')); ?> <small><?php echo e(trans('labels.EditNewscurrentCategories')); ?>...</small> </h1>
            <ol class="breadcrumb">
                <li><a href="<?php echo e(URL::to('admin/dashboard/this_month')); ?>"><i class="fa fa-dashboard"></i> <?php echo e(trans('labels.breadcrumb_dashboard')); ?></a></li>
                <li><a href="<?php echo e(URL::to('admin/newscategories')); ?>"><i class="fa fa-database"></i> <?php echo e(trans('labels.Categories')); ?></a></li>
                        ...
                        <div class="box-body">
                          ...
                          <h3 class="box-title">Edit category</h3>
                                        ...
                                        <div class="box-body">
                                            ...
                                            <?php echo Form::open(array('url' =>'admin/newscategories/update', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    ...
                                                    <img src="<?php echo e(asset('').$result['editCategory'][0]->path); ?>" alt="" width=" 100px">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <select class="form-control" name="categories_status">
                                                        <option value="1" <?php if($result['editCategory'][0]->categories_status==1): ?> selected <?php endif; ?>><?php echo e(trans('labels.Active')); ?></option>
                                                        <option value="0" <?php if($result['editCategory'][0]->categories_status==0): ?> selected <?php endif; ?>><?php echo e(trans('labels.Inactive')); ?></option>
                                                    </select>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/rumahsayurkita/resources/views/admin/newscategories/edit.blade.php ENDPATH**/ ?>