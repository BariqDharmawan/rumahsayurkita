              ...
              <ul class="top-right-list">
                <li class="panel">
                  ...
                  <div class="block">
                      ...
                      <p><?php echo app('translator')->get('website.bannerLabel1Text'); ?> <?php echo e($result['commonContent']['setting'][82]->value); ?></p>
                  </div>
                </li>
                  <li class="phone-header">
                    ...
                    <li class="dropdown head-cart-content">
                      <?php echo $__env->make('web.headers.cartButtons.cartButton7', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> 
                    </li>                    
              </ul>
            </div>
          </div>
...
<?php /**PATH /var/www/html/rumahsayurkita/resources/views/web/headers/headerSeven.blade.php ENDPATH**/ ?>