                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <select class="form-control" name="languages_id">
                                                        <?php $__currentLoopData = $result['languages']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($language->languages_id); ?>" <?php if($result['banners'][0]->languages_id == $language->languages_id): ?> selected <?php endif; ?>><?php echo e($language->name); ?></option>
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <select class="form-control" name="type" id="bannerType">
                                                        <option value="category" <?php if($result['banners'][0]->type=='category'): ?> selected <?php endif; ?>>
                                                            <?php echo e(trans('labels.Show Categegoires')); ?></option>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u596618187/domains/rumahsayurkita.com/public_html/resources/views/admin/Banners/edit.blade.php ENDPATH**/ ?>