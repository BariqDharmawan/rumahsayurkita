                      ...
                      <ul class="shopping-cart-items">
                        ...
                        <li>
                          ...
                          <div class="item-detail">
                              ...
                              <span class="item-s"><?php echo e($cart_data->customers_basket_quantity); ?> x <?php echo e(Session::get('symbol_left')); ?><?php echo e($cart_data->final_price*session('currency_value')); ?><?php echo e(Session::get('symbol_right')); ?> 
                                <a href="<?php echo e(URL::to('/deleteCart?id='.$cart_data->customers_basket_id)); ?>" class="icon" ><i class="fas fa-trash"></i></a></span>
                          </div>
                        </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <li>
...
-->
<?php /**PATH /var/www/html/rumahsayurkita/resources/views/web/headers/cartButtons/cartButton5.blade.php ENDPATH**/ ?>