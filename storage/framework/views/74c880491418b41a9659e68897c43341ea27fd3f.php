                                    ...
                                    <div class="box box-info">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <label for="name" class="col-sm-2 col-md-3 control-label"></label>
                                                <p class="col-md-4"><strong><?php echo e(trans('labels.Clear cache after update your this settings')); ?></strong>
                                            ...
                                            <div class="box-footer text-center">
                                                ...
                                                <a href="javascript:void(0)" class="clear-cache btn btn-danger">
                                                    <?php echo e(trans('labels.Clear Cache')); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u596618187/domains/rumahsayurkita.com/public_html/resources/views/admin/settings/general/facebookSettings.blade.php ENDPATH**/ ?>