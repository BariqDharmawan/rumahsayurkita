              		...
              		<div class="box box-info">
                        ...
                        <!-- form start -->                        
                         <div class="box-body">
                            ...
                            <?php echo Form::open(array('url' =>'admin/addnewcategoriesroles', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')); ?>
                             ...
                             <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                      ...
                                      <select class="form-control field-validate" name="admin_id">
                                          <option value=""><?php echo e(trans('labels.ChooseAdmin')); ?></option> 
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/rumahsayurkita/resources/views/admin/admins/roles/category/add.blade.php ENDPATH**/ ?>