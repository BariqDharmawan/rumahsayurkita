      ...
      <div class="product-hover d-none d-lg-flex d-xl-flex">
        ...
        <div class="mobile-icons d-lg-none d-xl-none">
            <div class="icons">
              ...
              <a onclick="myFunction3(<?php echo e($products->products_id); ?>)" class="icon swipe-to-top" data-toggle="tooltip" data-placement="bottom" title="<?php echo app('translator')->get('website.Compare'); ?>">
                <i class="fas fa-align-right" data-fa-transform="rotate-90"></i>
              </a>
...
<?php /**PATH /var/www/html/rumahsayurkita/resources/views/web/common/product_card_style/18.blade.php ENDPATH**/ ?>