                                ...
                                <div class="col-xs-12">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <th><?php echo e(trans('labels.deliveryboy status')); ?> </th>
                                        ...
                                        <?php if(count($listingOrders['orders'])>0): ?>
                                            <?php $__currentLoopData = $listingOrders['orders']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$orderData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if($orderData->deliveryboy_orders_status != ''): ?>
                                                            <span class="label label-primary">
                                                                <?php echo e($orderData->deliveryboy_orders_status); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/uloydev/project/web/laravel/rumahsayurkita/resources/views/admin/Orders/index.blade.php ENDPATH**/ ?>