  ...
  <?php endif; ?>
              ...
              <?php if(!in_array($products->products_id,$result['cartArray'])): ?>
                  ...
                  <?php else: ?>
                      ...
                      <button class="btn-secondary icon swipe-to-top cart" products_id="<?php echo e($products->products_id); ?>" data-toggle="tooltip" data-placement="bottom" title="<?php echo app('translator')->get('website.Add to Cart'); ?>">
          ...
          <?php endif; ?>
                              ...
                              <button class="btn-secondary icon swipe-to-top modal_show" products_id ="<?php echo e($products->products_id); ?>" data-toggle="tooltip" data-placement="bottom" title="<?php echo app('translator')->get('website.Quick View'); ?>">
                                <i class="fas fa-eye"></i>
                              </button>
                              <button onclick="myFunction3(<?php echo e($products->products_id); ?>)" class="btn-secondary icon swipe-to-top" data-toggle="tooltip" data-placement="bottom" title="<?php echo app('translator')->get('website.Compare'); ?>">
       ...
       ?>                                 
        ...
        <?php endif; ?>                        
                            ...
                            <button  class="btn-secondary icon swipe-to-top is_liked" products_id="<?=$products->products_id?>" data-toggle="tooltip" data-placement="bottom" title="<?php echo app('translator')->get('website.Wishlist'); ?>">
                ...
                </div><?php /**PATH /var/www/html/rumahsayurkita/resources/views/web/common/product_card_style/22.blade.php ENDPATH**/ ?>