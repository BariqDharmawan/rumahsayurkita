                   ...
                   <form name="signup" enctype="multipart/form-data" class="form-validate"  action="<?php echo e(URL::to('/checkout_shipping_address')); ?>" method="post">
                     ...
                     <div class="form-row">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" required class="form-control field-validate" data-toggle="modal" data-target="#mapModal" name="location" id="location" aria-describedby="addressHelp" placeholder="<?php echo app('translator')->get('website.Please enter your location or click here to open map'); ?>" value="<?php if(!empty(session('shipping_address'))): ?> <?php echo e(session('shipping_address')->location); ?><?php endif; ?>">
                       
                      </div>
                      <?php }?>
                      <input type="hidden" name="latitude" id="latitude" value="<?php if(!empty(session('shipping_address'))): ?> <?php echo e(session('shipping_address')->latitude); ?><?php endif; ?>">
                      <input type="hidden" name="longitude" id="longitude" value="<?php if(!empty(session('shipping_address'))): ?> <?php echo e(session('shipping_address')->longitude); ?><?php endif; ?>">
                      <div class="form-group">
...
<?php echo $__env->make('web.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/uloydev/project/web/laravel/rumahsayurkita/resources/views/web/checkout.blade.php ENDPATH**/ ?>