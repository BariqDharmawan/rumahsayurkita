        ...
        <div class="col-12 col-lg-4">
          ...
          <div class="form">
            <form enctype="multipart/form-data" action="<?php echo e(URL::to('/processContactUs')); ?>" method="post">
              ...
              <input type="text" placeholder="<?php echo app('translator')->get('website.Please enter your name'); ?>">
              <input type="email" placeholder="<?php echo app('translator')->get('website.Enter Email here'); ?>..">
              <textarea name="message"  placeholder="<?php echo app('translator')->get('website.Please enter your message'); ?>" rows="5" cols="56"></textarea>
              <span class="help-block error-content" hidden><?php echo app('translator')->get('website.Please enter your message'); ?></span>
              <button type="submit" class="btn btn-secondary swipe-to-top" ><?php echo app('translator')->get('website.Submit'); ?></button>
            </form>
          </div>
        </div>
        <div class="col-12 col-lg-3">
          ...
          <div class="newsletter">
            <h5><?php echo app('translator')->get('website.Newsletter'); ?></h5>
            <div class="block">
...
<?php /**PATH /var/www/html/rumahsayurkita/resources/views/web/footers/footer4.blade.php ENDPATH**/ ?>