...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1><?php echo e($result['month']); ?> <?php echo e(trans('labels.Earning by Vendors')); ?> <small><?php echo e($result['month']); ?> <?php echo e(trans('labels.Earning by Vendors')); ?>...</small> </h1>
        <ol class="breadcrumb">
            ...
            <li class="active"><?php echo e($result['month']); ?> <?php echo e(trans('labels.Earning by Vendors')); ?></li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><?php echo e($result['month']); ?> <?php echo e(trans('labels.Earning by Vendors')); ?> </h3>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <table id="example1" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            <th><?php echo e(trans('labels.Vendors')); ?></th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?php echo e($monthlyearning['vendors']); ?></td>
                                            ...
                                            <!-- <td>
                                                <a class="btn btn-primary" style="width: 100%; margin-bottom: 5px;"
                                                    href="<?php echo e(url('admin/finance/monthreport/'. $result['month'] .'/vendor/' .$monthlyearning['vendors_id'])); ?>"><?php echo e(trans('labels.View')); ?></a>
                                            </td> -->
                                            <td>
                                                <a class="btn btn-primary" style="width: 100%; margin-bottom: 5px;"
                                                    href="<?php echo e(url('admin/finance/sattlement/'. $result['month'] .'/vendor/' .$monthlyearning['vendors_id'])); ?>"><?php echo e(trans('labels.View')); ?></a>
                                            </td>
                                        ...
                                        <tr>
                                            <td colspan="5" style="font-size: 16px; text-align: right;"><strong><?php echo e(trans('labels.Total Paid by customer')); ?></strong></td>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/rumahsayurkita/resources/views/admin/deliveryboys/finance/month.blade.php ENDPATH**/ ?>