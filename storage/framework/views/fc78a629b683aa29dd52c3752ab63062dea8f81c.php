    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo e(URL::to('admin/deliveryboys/pages')); ?>"><i class="fa fa-dashboard"></i> <?php echo e(trans('labels.ListingAllPages')); ?></a></li>
                                ...
                                <div class="col-xs-12">
                                    <div class="box box-info">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <?php echo Form::open(array('url' =>'admin/deliveryboys/updatepage', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')); ?>
                                            ...
                                            <div class="box-footer text-center">
                                                ...
                                                <a href="<?php echo e(URL::to('admin/deliveryboys/pages')); ?>" type="button" class="btn btn-default"><?php echo e(trans('labels.back')); ?></a>
                                            </div>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/rumahsayurkita/resources/views/admin/pages/deliveryboys/edit.blade.php ENDPATH**/ ?>