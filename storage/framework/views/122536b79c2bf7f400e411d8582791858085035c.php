                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    ...
                                                    <!-- Modal -->
                                                        ...
                                                        <div  id ="imageselected">
                                                            ...
                                                            <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;"><?php echo e(trans('labels.Language icon size should be 30x20')); ?></span>
                                                            <div class="closimage">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/rumahsayurkita/resources/views/admin/languages/edit.blade.php ENDPATH**/ ?>