    ...
    <tr <?php if($key++==0): ?> id="content_<?=$values_data->products_options_id.'_'.$values_data->language_id?>" <?php endif; ?>>
        <td>
             ...
             <div style="display:none" class="row form-content-<?=$values_data->products_options_id.$values_data->products_options_values_id?>">
           			<?php echo Form::open(array('url' =>'admin/products/attributes/options/values/updateAttributeValue', 'method'=>'post', 'class' => 'form-horizontal form-validate editvalue-form', 'enctype'=>'multipart/form-data')); ?>
...
<?php /**PATH /var/www/html/rumahsayurkita/resources/views/admin/products_attributes/options/attributesTable.blade.php ENDPATH**/ ?>