    ...
    <div class="thumb">
      ...
      <div class="product-action">
        ...
        <div class="btn btn-block btn-secondary icon swipe-to-top modal_show" products_id ="<?php echo e($products->products_id); ?>" data-toggle="tooltip" data-placement="bottom" title="<?php echo app('translator')->get('website.Quick View'); ?>">
          <i class="fas fa-eye"></i> <?php echo app('translator')->get('website.Quick View'); ?>
        </div>
...
<?php /**PATH /var/www/html/rumahsayurkita/resources/views/web/common/product_card_style/15.blade.php ENDPATH**/ ?>