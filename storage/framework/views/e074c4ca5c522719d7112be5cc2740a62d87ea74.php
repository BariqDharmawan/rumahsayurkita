<div class="product product4 ">
        ...
        <?php endif; ?>
                ...
                <a onclick="myFunction3(<?php echo e($products->products_id); ?>)" class="icon swipe-to-top" data-toggle="tooltip" data-placement="bottom" data-original-title="<?php echo app('translator')->get('website.Compare'); ?>"><i class="fas fa-align-right" data-fa-transform="rotate-90"></i></a>
...
?></p>
        ...
        <?php endif; ?>
          ...
          </div><?php /**PATH /var/www/html/rumahsayurkita/resources/views/web/common/product_card_style/4.blade.php ENDPATH**/ ?>