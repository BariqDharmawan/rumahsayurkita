              ...
              <div class="row">
                    <div class="col-12 col-lg-5">
                      ...
                      <div class="slider-wrapper">
                          <div class="slider-for">
                            <a class="slider-for__item ex1 fancybox-button" href="<?php echo e(asset('').$result['detail']['product_data'][0]->image_path); ?>" data-fancybox-group="fancybox-button" title="<?php echo app('translator')->get('website.modal_text_1'); ?>">
                            ...
                            <?php $__currentLoopData = $result['detail']['product_data'][0]->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$images): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              ...
                              <a class="slider-for__item ex1 fancybox-button" href="<?php echo e(asset('').$images->image_path); ?>" data-fancybox-group="fancybox-button" title="<?php echo app('translator')->get('website.modal_text_1'); ?>">
                    ...
                    <div class="col-12 col-lg-7" >
                        ...
                        <div class="product-buttons">
                            <h2><?php echo app('translator')->get('website.Total Price'); ?>:
                              ...
                              <?php if($result['detail']['product_data'][0]->products_min_order>0): ?>
                                <p>
                                  <?php if($result['detail']['product_data'][0]->products_type == 0): ?>
                                   <span id="min_max_setting">&nbsp; <?php echo app('translator')->get('website.Min Order Limit:'); ?></span>
                                    	  ...
                                    	  <div class="card" style="margin-bottom:10px;">
                                            ...
                                            <div class="row">
                                              <div class="col-sm-4" style="display: flex;flex-direction: column;    justify-content: center;    align-items: flex-end;">
                                                <p style="font-size: 51px;font-weight: 700;color: black;margin-bottom: -10px;"><?php echo e($result['detail']['product_data'][0]->rating); ?></p>
                                              ...
                                              <div class="col-sm-8">
                                                         <div class="row rating-desc" >
                                                                ...
                                                                <div class="col-xs-8 col-md-12" style="display: flex;justify-content: start;">
                                                                    <div class="progress progress-striped">
                                                                        <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="20"
                                                                            aria-valuemin="0" aria-valuemax="100" style="width: <?php echo e($result['detail']['product_data'][0]->five_ratio); ?>%">
                                                                ...
                                                                <div class="col-xs-8 col-md-12" style="display: flex;justify-content: start;">
                                                                    <div class="progress">
                                                                        <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="20"
                                                                            aria-valuemin="0" aria-valuemax="100" style="width: <?php echo e($result['detail']['product_data'][0]->four_ratio); ?>%">
                                                              ...
                                                              <div class="col-xs-8 col-md-12" style="display: flex;justify-content: start;">
                                                                    <div class="progress">
                                                                        <div class="progress-bar progress-bar-info" role="progressbar" aria-valuenow="20"
                                                                            aria-valuemin="0" aria-valuemax="100" style="width: <?php echo e($result['detail']['product_data'][0]->three_ratio); ?>%">
                                                              ...
                                                              <div class="col-xs-8 col-md-12" style="display: flex;justify-content: start;">
                                                                    <div class="progress">
                                                                        <div class="progress-bar progress-bar-warning" role="progressbar" aria-valuenow="20"
                                                                            aria-valuemin="0" aria-valuemax="100" style="width: <?php echo e($result['detail']['product_data'][0]->two_ratio); ?>%">
                                                                ...
                                                                <div class="col-xs-8 col-md-12" style="display: flex;justify-content: start;">
                                                                    <div class="progress">
                                                                        <div class="progress-bar progress-bar-danger" role="progressbar" aria-valuenow="80"
                                                                            aria-valuemin="0" aria-valuemax="100" style="width: <?php echo e($result['detail']['product_data'][0]->one_ratio); ?>%">
                                             ...
                                             <?php $__currentLoopData = $result['detail']['product_data'][0]->reviewed_customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$rev): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    	        <div class="row">
                                                    ...
                                                    <div class="row">
                                                          ...
                                                          <div class="col-sm-12">
                                                            <div class="review-single <?php if($key%2 == 0): ?> even <?php endif; ?>">
                                                              <h3><?php echo e($rev->customers_name); ?></h3>
                                                              ...
                                                              <p>
                                                                <?php echo e($rev->reviews_text); ?>

                                                              </p>

                                                              <span class="text-dark"><?php echo e(Carbon\Carbon::now()->subDays(date("d", strtotime($rev->created_at)))->diffForHumans()); ?></span>
                                                            </div>
                                                          </div>
                                    ...
                                    <div class="tabs-pera">
                                      <div class="container">
                                        ...
                                        <div class="form-group" style="width:100%; padding:0;">
                                            ...
                                            <textarea required name="comments" value="<?php echo e(session::get('comments')); ?>" class="form-control" rows="3"></textarea>
                                          </div>
...
<?php /**PATH /var/www/html/rumahsayurkita/resources/views/web/common/modal.blade.php ENDPATH**/ ?>