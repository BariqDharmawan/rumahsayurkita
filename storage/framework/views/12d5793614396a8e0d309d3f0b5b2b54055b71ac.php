...
<div class="modal-body">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10 col-md-8">
            <?php echo Form::text('entry_postcode', $data['customer_addresses'][0]->entry_postcode, array('class'=>'form-control field-validate', 'id'=>'entry_postcode')); ?>
...
<?php /**PATH /var/www/html/rumahsayurkita/resources/views/admin/customers/address/editaddress.blade.php ENDPATH**/ ?>