                                ...
                                <div class="col-xs-12">
                                    ...
                                    <!-- /.box-header -->
                                        ...
                                        <div class="box-body">
                                            ...
                                            <?php echo Form::hidden('id',  $editManufacturer->id , array('class'=>'form-control', 'id'=>'id')); ?>

                                            <?php echo Form::hidden('oldImage',  $editManufacturer->image , array('id'=>'oldImage')); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <?php echo Form::text('name',  $editManufacturer->name , array('class'=>'form-control field-validate', 'id'=>'name'), value(old('name'))); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <input type="hidden" name="old_slug" value="<?php echo e($editManufacturer->slug); ?>">
                                                    <input type="text" name="slug" class="form-control field-validate" value="<?php echo e($editManufacturer->slug); ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <?php echo Form::text('manufacturers_url',  $editManufacturer->url , array('class'=>'form-control', 'id'=>'manufacturers_url'), value(old('manufacturers_url'))); ?>
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    ...
                                                    <!-- Modal -->
                                                        ...
                                                        <div id ="imageselected">
                                                            ...
                                                            <?php if(($editManufacturer->path!== null)): ?>
                                                                <img width="80px" src="<?php echo e(asset($editManufacturer->path)); ?>">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/rumahsayurkita/resources/views/admin/manufacturers/edit.blade.php ENDPATH**/ ?>