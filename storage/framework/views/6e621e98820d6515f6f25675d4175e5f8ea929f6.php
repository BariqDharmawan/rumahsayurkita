...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1> <?php echo e(trans('labels.Adddeliveryboy')); ?> <small><?php echo e(trans('labels.Adddeliveryboy')); ?>...</small> </h1>
        <ol class="breadcrumb">
            ...
            <li class="active"><?php echo e(trans('labels.Adddeliveryboy')); ?></li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><?php echo e(trans('labels.Adddeliveryboy')); ?> </h3>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        <?php echo Form::open(array('url' =>'admin/deliveryboys/add', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')); ?>
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="row">
                                            <div class="col-xs-12 col-sm-6">
                                              <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-8">
                                                  <?php echo Form::text('dob',  '', array('class'=>'form-control datepicker' , 'id'=>'dob', 'readonly'=>'readonly')); ?>
                                            ...
                                            <div class="col-xs-12 col-sm-6">
                                              ...
                                              <div class="col-sm-10 col-md-8">
                                                  <select name="blood_group" class="form-control">
                                                    <OPTION VALUE="A +ve"><?php echo e(trans('labels.A +ve')); ?> </OPTION>
                                                    <OPTION VALUE="A -ve"><?php echo e(trans('labels.A -ve')); ?> </OPTION>
                                                    <OPTION VALUE="B +ve"><?php echo e(trans('labels.B +ve')); ?>  </OPTION>
                                                    <OPTION VALUE="B -ve"><?php echo e(trans('labels.B -ve')); ?> </OPTION>
                                                    <OPTION VALUE="O +ve"><?php echo e(trans('labels.O +ve')); ?></OPTION>
                                                    <OPTION VALUE="O -ve"><?php echo e(trans('labels.O -ve')); ?> </OPTION>
                                                    <OPTION VALUE="AB +ve"><?php echo e(trans('labels.AB +ve')); ?> </OPTION>
                                                    <OPTION VALUE="AB -ve"><?php echo e(trans('labels.AB -ve')); ?>AB -ve </OPTION>
                                                  </select>
                                                 <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                          ...
                                          <div class="row">
                                            <div class="col-xs-12 col-sm-6">
                                              ...
                                              <div class="col-sm-10 col-md-8">
                                                <?php echo Form::text('commission',  '0', array('class'=>'form-control field-validate' , 'id'=>'commission')); ?>
                                            ...
                                            <div class="row">
                                              ...
                                              <div class="col-xs-12 col-sm-6">
                                                <div class="form-group">
                                                  ...
                                                  <div class="col-sm-10 col-md-8">
                                                    <?php echo Form::text('password', '', array('class'=>'form-control field-validate', 'id'=>'password')); ?>
                                                  ...
                                                  <div class="col-sm-10 col-md-8">
                                                    <select class="form-control" name="availability_status">
                                                        <?php $__currentLoopData = $data['statuses']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                          <option value="<?php echo e($status->orders_status_id); ?>"><?php echo e($status->orders_status_name); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                	                  </select>
                                                  <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                  <?php echo e(trans('labels.StatusText')); ?></span>
                                            ...
                                            <div class="row">
                                              ...
                                              <div class="col-xs-12 col-sm-6">
                                                <div class="form-group">
                                                  ...
                                                  <div class="col-sm-10 col-md-8">
                                                    <?php echo Form::text('address', '', array('class'=>'form-control field-validate', 'id'=>'address')); ?>
                                              ...
                                              <div class="col-xs-12 col-sm-6">
                                                <div class="form-group">
                                                  ...
                                                  <div class="col-sm-10 col-md-8">
                                                    <?php echo Form::text('city', '', array('class'=>'form-control field-validate', 'id'=>'City')); ?>
                                          ...
                                          <div class="row">
                                              ...
                                              <div class="col-xs-12 col-sm-6">
                                                <div class="form-group">
                                                  ...
                                                  <div class="col-sm-10 col-md-8">
                                                    <?php echo Form::text('zip', '', array('class'=>'form-control field-validate', 'id'=>'zip')); ?>
                                            ...
                                            <hr>
                                            <h4><?php echo e(trans('labels.Vehicle Info')); ?></h4>
                                            <hr>

                                            <div class="row">
                                              <div class="col-xs-12 col-sm-6">
                                                <div class="form-group">
                                                  <label for="name" class="col-sm-2 col-md-3 control-label"><?php echo e(trans('labels.Vehicle_name')); ?></label>
                                                  <div class="col-sm-10 col-md-8">
                                                    <?php echo Form::text('bike_name', '', array('class'=>'form-control field-validate', 'id'=>'bike_name')); ?>

                                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                   <?php echo e(trans('labels.Vehicle_nameText')); ?></span>
                                                    <span class="help-block hidden"><?php echo e(trans('labels.textRequiredFieldMessage')); ?></span>
                                                  </div>
                                                </div>
                                              </div>
                                              <div class="col-xs-12 col-sm-6">
                                                <div class="form-group">
                                                  ...
                                                  <div class="col-sm-10 col-md-8">
                                                    <?php echo Form::text('owner_name', '', array('class'=>'form-control field-validate', 'id'=>'owner_name')); ?>
                                            ...
                                            <div class="row">
                                              <div class="col-xs-12 col-sm-6">
                                                ...
                                                <div class="form-group">
                                                  <label for="name" class="col-sm-2 col-md-3 control-label"><?php echo e(trans('labels.Vehicle_color')); ?></label>
                                                  <div class="col-sm-10 col-md-8">
                                                    <?php echo Form::text('bike_color', '', array('class'=>'form-control field-validate', 'id'=>'bike_color')); ?>

                                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                   <?php echo e(trans('labels.Vehicle_colorText')); ?></span>
                                                    <span class="help-block hidden"><?php echo e(trans('labels.textRequiredFieldMessage')); ?></span>
                                                  </div>
                                                </div>
                                              ...
                                              <div class="col-xs-12 col-sm-6">
                                                <div class="form-group">
                                                  ...
                                                  <div class="col-sm-10 col-md-8">
                                                    <?php echo Form::text('vehicle_registration_number', '', array('class'=>'form-control field-validate', 'id'=>'vehicle_registration_number')); ?>
                                            ...
                                            <div class="row">
                                              <div class="col-xs-12 col-sm-6">
                                                <div class="form-group">
                                                  <label for="name" class="col-sm-2 col-md-3 control-label"><?php echo e(trans('labels.Vehicle_details')); ?></label>
                                                  <div class="col-sm-10 col-md-8">
                                                    <?php echo Form::text('bike_details', '', array('class'=>'form-control field-validate', 'id'=>'bike_details')); ?>

                                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                   <?php echo e(trans('labels.Vehicle_detailsText')); ?></span>
                                                    <span class="help-block hidden"><?php echo e(trans('labels.textRequiredFieldMessage')); ?></span>
                                                  </div>
                                                </div>
                                              </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-8">
                                                    <?php echo Form::text('bank_name', '', array('class'=>'form-control
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-8">
                                                    <?php echo Form::text('bank_address', '',
                                                    array('class'=>'form-control field-validate',
                                                    'id'=>'bank_address')); ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-6">
                                            ...
                                            <div class="box-footer text-center">
                                              ...
                                              <button type="submit" class="btn btn-primary pull-right"><?php echo e(trans('labels.Adddeliveryboy')); ?></button>
                                            </div>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/rumahsayurkita/resources/views/admin/deliveryboys/add.blade.php ENDPATH**/ ?>