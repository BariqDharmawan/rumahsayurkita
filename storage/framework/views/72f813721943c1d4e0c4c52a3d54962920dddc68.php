   ...
   <div class="content text-center">
     ...
     <div class="price">                     
      ...
      <?php elseif($products->products_type==2): ?>
          <a href="<?php echo e($products->products_url); ?> swipe-to-top" target="_blank" class="btn btn-secondary" data-toggle="tooltip" data-placement="bottom" title="<?php echo app('translator')->get('website.External Link'); ?>"><i class="fas fa-shopping-bag"></i><?php echo app('translator')->get('website.External Link'); ?></a>
      <?php endif; ?>
...
</div><?php /**PATH /var/www/html/rumahsayurkita/resources/views/web/common/product_card_style/5.blade.php ENDPATH**/ ?>