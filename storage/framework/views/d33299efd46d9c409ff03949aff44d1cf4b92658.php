...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo e(URL::to('admin/pages')); ?>"><i class="fa fa-gears"></i> <?php echo e(trans('labels.ListingAllPages')); ?></a></li>
                         ...
                         <div class="box-body">
                          ...
                          <?php endif; ?>
							...
							<div class="box-footer text-center">
								...
								<a href="<?php echo e(URL::to('admin/pages')); ?>" type="button" class="btn btn-default"><?php echo e(trans('labels.back')); ?></a>
							</div>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u596618187/domains/rumahsayurkita.com/public_html/resources/views/admin/pages/add.blade.php ENDPATH**/ ?>