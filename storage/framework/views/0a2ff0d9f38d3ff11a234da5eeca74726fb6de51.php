                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="row">
                                                        ...
                                                        <div class="box box-info">
                                                            ...
                                                            <div class="box-body">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-10 col-md-8">
                                                                        <p class="purchase_price_content" style="width:100%">
                                                                            <?php if(!empty($result['commonContent']['currency']->symbol_left)): ?> <?php echo e($result['commonContent']['currency']->symbol_left); ?> <?php endif; ?> <?php if(!empty($result['commonContent']['currency']->symbol_right)): ?> <?php echo e($result['commonContent']['currency']->symbol_right); ?> <?php endif; ?>
                                                                            <span id="total_purchases"><?php echo e($result['purchase_price']); ?></span></p><br>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-10 col-md-8">
                                                                        <p class="purchase_price_content" style="width:100%"><?php if(!empty($result['commonContent']['currency']->symbol_left)): ?> <?php echo e($result['commonContent']['currency']->symbol_left); ?> <?php endif; ?> <?php if(!empty($result['commonContent']['currency']->symbol_right)): ?> <?php echo e($result['commonContent']['currency']->symbol_right); ?> <?php endif; ?><span id="total_purchases"><?php echo e($result['purchase_price']); ?></span></p><br>
                                            ...
                                            <div class="box-footer col-xs-12">
                                                ...
                                                <?php endif; ?>
                                                <a href="<?php echo e(URL::to("admin/products/images/display/{$result['products'][0]->products_id}")); ?>" class="btn btn-primary pull-right"> <?php echo e(trans('labels.Save_And_Continue')); ?> <i class="fa fa-angle-right"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/rumahsayurkita/resources/views/admin/products/inventory/add.blade.php ENDPATH**/ ?>