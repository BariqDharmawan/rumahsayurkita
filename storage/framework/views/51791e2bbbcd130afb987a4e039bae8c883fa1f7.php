        ...
        <div class="row">
          <div class="col-12 col-md-6 col-lg-6">
              <div class="row">
                ...
                <div class="col-6">
                    <h5><?php echo app('translator')->get('website.TAGS'); ?></h5>
                    <ul class="links-tag pl-0 mb-0">
                      <?php if(!empty($result['categories'])): ?>
                       <?php $__currentLoopData = $result['categories']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li> <a href="<?php echo e(url('shop?category=').$category->slug); ?>"><?php echo e($category->categories_name); ?></a> </li>
...
<?php /**PATH /var/www/html/rumahsayurkita/resources/views/web/footers/footer9.blade.php ENDPATH**/ ?>