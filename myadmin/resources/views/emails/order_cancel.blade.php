                ...
                <table>
                    <tr>
                        <td>
                            ...
                            <p style="font-size: 16px;color: #5f5e5e;line-height: 1.5;margin-top: 10px;">Orderan Anda #{{$order_code}} Telah di Cancel</p>
                    ...
                    <table style="width:100%">
                        ...
                        <tr>
                            <td style="background-color: #4d4d4d;padding: 15px 25px;text-align: center;border-top: 1px solid #fff;">
                                ...
                                <p style="color: #a2a1a1;font-size:14px;"><b>No Bantuan:</b> +62 0987654321</p>
