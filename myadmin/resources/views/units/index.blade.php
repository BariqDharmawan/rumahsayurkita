...
@section('content')
    ...
    @include('layouts.message')
                    <h4 class="card-title">All Products Units</h4>
                    <div id="main">
                    </div>
                    <div class="box-tools pull-right">

                        <a class="btn waves-effect waves-light  btn-success" href="{{route('addnewUnit')}}">Add New</a></div>
                    ...
                    <div class="table-responsive m-t-40">
                        <table id="cmsTable" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <tfoot>
                                <tr>
                                    <th><button id="delete_all" type="button" data-action='units' class="btn btn-danger">Delete</button></th>
                                    <th>Unit Name</th>
                                    <th>Unit Code</th>
                                    <th>Status</th>
                                    <th>Action</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('editUnit', ['id' => $cat->id])}}" class="toolTip" data-toggle="tooltip" data-placement="bottom" title="Edit Page"><i class="fa fa-pencil"></i></a>                                        &nbsp;&nbsp;&nbsp;
                                        <a href="{{route('viewUnit', ['id' => $cat->id])}}" class="toolTip" data-toggle="tooltip" data-placement="bottom" title="View Page"><i class="fa fa-eye"></i></a>&nbsp;&nbsp;&nbsp;
