  ...
  <header class="main-header">
    ...
    <a href="#!" class="logo">
      ...
      <span class="logo-mini"><b>R</b>S</b>K</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Rumah Sayur</b> Kita</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="{{route('changePassword')}}" class="btn btn-default btn-flat">Ganti Password</a>
                </div>
