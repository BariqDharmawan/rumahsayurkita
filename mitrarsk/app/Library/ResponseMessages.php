...
class ResponseMessages {
    ...
    public static function getStatusCodeMessages($status) {
        $codes = array(
            ...
            40 => 'Username Atau No Handphone tidak valid',
            ...
            503 => 'Anda belum bisa login, karena status akun anda masih dalam proses approval dari kami!',
            504 => 'Anda sudah melakukan pesanan hari ini, Tunggu Besok lagi ya pesannya!',
            505 => 'Maaf, jam order sudah tutup (max. jam 19.00 WIB). Silahkan bertransaksi kembali esok hari. Thx',
            506 => 'Maaf, jam order sudah tutup (max. jam 19.00 WIB). Silahkan bertransaksi kembali esok hari. Thx',
        );
