...
class MyController extends Controller {
    ...
    public function send_sms_forgot($number, $otp) {
        ...
        $msg = $otp . " is your verification OTP for forgot password into the GroceryStore app. Do not share this OTP with anyone.";
        // Message details
    ...
    public function send_sms($number, $otp) {
        $apiKey = urlencode('/tDnTktPlE4-X6mcUH5AHDxxloyjCy2DEgVXTvNdaO');
        $msg = $otp . " is your verification OTP for registration into the GroceryStore app. Do not share this OTP with anyone.";
        // Message details
        $numbers = array($number);
        $sender = urlencode($this->getBusRuleRef("sms_sender_id"));
        $message = rawurlencode($msg);
