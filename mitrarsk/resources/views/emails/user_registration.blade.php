            ...
            <table>
                <tr>
                    <td>
                        ...
                        <p style="font-size: 16px;color: #5f5e5e;line-height: 1.5;margin-top: 10px;">Thank you for signing up with GroceryStore</p>
                    </td>
                </tr>
                ...
                <table style="width:100%">
                    ...
                    <tr>
                        <td style="background-color: #4d4d4d;padding: 15px 25px;text-align: center;border-top: 1px solid #fff;">
                            ...
                            <p style="color: #a2a1a1;font-size:14px;"><b>24 X 7:</b> <a href="mailto:noreply@GroceryStore.com" style="color:#fff;">noreply@GroceryStore.com</a></p>
                        </td>
                    </tr>
                </table>
