...
@section('content')
    ...
    @include('layouts.message')
                    ...
                    <div class="box-tools pull-right">
                        <a class="btn waves-effect waves-light  btn-success" href="{{route('addCoupon')}}">Add New</a></div>
                        ...
                        <table id="cmsTable" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ucfirst(config('constants.STATUS.'.$coupon->status))}}</td>
                                    <td>
                                        <a href="{{route('editCoupon', ['id' => $coupon->id])}}" class="toolTip" data-toggle="tooltip" data-placement="bottom"
                                            title="Edit Coupon">Edit Coupon</a>
                                        <br>
                                        <a href="{{route('viewCoupon', ['id' => $coupon->id])}}" class="toolTip" data-toggle="tooltip" data-placement="bottom"
                                            title="View Coupon">View Coupon</a>
                                        <br>
                                        <a href="#!" class="img-responsive model_img delete" id="sa-warning" data-id="{{$coupon->id}}">Delete Coupon</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
    ...
    $(function(){
		 ...
		 $(document).on('click', '.delete', function() {
             ...
             if(con)
             {
                $.ajax({
                    method: 'post',
                    url: '{{URL::to("/admin/coupons/destroy") }}',
                    data: {
                        '_token': "{{csrf_token()}}",
                        'id': $(this).data('id')
                    },
