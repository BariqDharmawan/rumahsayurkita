          ...
          <ul class="pro-header-options">
            <li>
              <p>
                ...
                @lang('website.Welcome') {{auth()->guard('customer')->user()->first_name}}&nbsp;! <?php }?>
              </p>
            </li>
            <li class="dropdown">
              ...
              <div class="dropdown-menu">
                ...
                <a class="dropdown-item" href="{{url('wishlist')}}">
                  ...
                  <span class="total_wishlist">
                    ({{$result['commonContent']['total_wishlist']}})
                  </span>
                </a>
                ...
                <?php }else{ ?>
                <a class="dropdown-item" href="{{ URL::to('/login')}}"><i class="fa fa-lock"
      ...
      <div class="row align-items-center">
            ...
            <div class="search-field-module">
              ...
              <div class="search-field-wrap">
                ...
                <button class="btn btn-secondary swipe-to-top" data-toggle="tooltip" data-placement="bottom"
                  title="@lang('website.Search Products')">
        ...
        <div class="col-6 col-sm-6 col-md-4 col-lg-3">
          <ul class="pro-header-right-options">
            <li>
              <a href="{{ URL::to('/wishlist')}}" class="btn" data-toggle="tooltip" data-placement="bottom"
                title="@lang('website.Wishlist')">
